...
///////////////////////////////////////////////////////////////////////////////////////////
    /* Definición de la estructura para almacenar toda la información relativa para el predictor teniendo 3 PHT */
    struct {
      int l1size;		/* level-1 size, number of history regs */
      int l2size;		/* level-2 size, number of pred states */
      int shift_width;		/* amount of history in level-1 shift regs */
      ...
      int *shiftregs;		/* level-1 history table */
      unsigned char *l2table;	/* level-2 prediction state table */
      unsigned char *l2table2;	/* level-2 prediction state table */
      unsigned char *l2table3;	/* level-2 prediction state table */
    } gskew;
///////////////////////////////////////////////////////////////////////////////////////////    
  } config;
};
...
///////////////////////////////////////////////////////////////////////////////////////////    
    struct bpred_dir_t *gskew;	  /* Gskew direction predictor */
///////////////////////////////////////////////////////////////////////////////////////////    
...
///////////////////////////////////////////////////////////////////////////////////////////  
  counter_t used_gskew;		/* num 2-level predictions used (BPredComb) */
///////////////////////////////////////////////////////////////////////////////////////////  
...
///////////////////////////////////////////////////////////////////////////////////////////  
  char *pdir3;		/* direction-3 predictor counter para la tercera tabla*/
///////////////////////////////////////////////////////////////////////////////////////////  
...
///////////////////////////////////////////////////////////////////////////////////////////    
    unsigned int gskew  : 1;	/* Gskew predictor */
///////////////////////////////////////////////////////////////////////////////////////////    
